...
def main():
    ...
    assert np.allclose(byname['SM_BrokenBridge.glb']['bounds_y_up_m'],byname['BrokenBridge_Modular.glb']['bounds_y_up_m'],atol=1e-5)
    assert byname['Reuse_3_Instances.glb']['mesh_count']==1
    assert byname['Reuse_3_Instances.glb']['node_count']==3
    ...
    (ROOT/'validation/validation_report.json').write_text(json.dumps(data,indent=2),encoding='utf8')
