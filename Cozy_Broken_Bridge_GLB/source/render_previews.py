...
imp=vtk.vtkGLTFImporter();imp.SetFileName(str(root/'models/SM_BrokenBridge.glb'));imp.SetRenderWindow(w);imp.Update()
...
for name,pos,target,up,scale in views:
    ...
    d.text((22,1219),'ACTUAL GLB RENDER  /  '+name[3:].replace('_',' ').upper(),font=font,fill=(230,235,224))
    d.text((1130,1219),'27,016 triangles   |   1 atlas material   |   2K',font=font,fill=(230,235,224))
...
report={'renderer':'VTK '+vtk.vtkVersion.GetVTKVersion()+' / EGL offscreen',
        'source':'models/SM_BrokenBridge.glb','importer':'vtkGLTFImporter',
